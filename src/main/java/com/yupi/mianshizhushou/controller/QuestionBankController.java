...
import com.yupi.mianshizhushou.model.dto.questionBank.QuestionBankAddRequest;
import com.yupi.mianshizhushou.model.dto.questionBank.QuestionBankEditRequest;
import com.yupi.mianshizhushou.model.dto.questionBank.QuestionBankQueryRequest;
import com.yupi.mianshizhushou.model.dto.questionBank.QuestionBankUpdateRequest;
import com.yupi.mianshizhushou.model.entity.Question;
import com.yupi.mianshizhushou.model.entity.QuestionBank;
...
import com.yupi.mianshizhushou.service.QuestionBankService;
...
public class QuestionBankController {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        Long id = questionBankQueryRequest.getId();//获取题库id
        ThrowUtils.throwIf(id <= 0, ErrorCode.PARAMS_ERROR);
        //生成key
        String keyPrefix = "bank_detail_";
        ...
        //是否需要关联题库中的题目列表
        boolean needQueryBankList = questionBankQueryRequest.isNeedQueryBankList();
        if (needQueryBankList) {
            QuestionQueryRequest questionQueryRequest = new QuestionQueryRequest();
            questionQueryRequest.setId(id);
            Page<Question> questionPage = questionService.listQuestionByPage(questionQueryRequest);
            questionBankVO.setQuestionPage(questionPage);
        }
        //设置本地缓存 是热点key才会缓存数据 不是热点key不会缓存数据
